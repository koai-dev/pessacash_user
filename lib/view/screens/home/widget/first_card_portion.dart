                          ...
                          builder: (profileController) {
                            return Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                                profileController.userInfo != null?
                                Text('(${'sent'.tr} ${PriceConverter.balanceWithSymbol(balance: profileController.userInfo.pendingBalance != null?profileController.userInfo.pendingBalance.toString():0)} ${'withdraw_req'.tr})',
                                    style: rubikMedium.copyWith(fontSize: Dimensions.FONT_SIZE_SMALL,)):SizedBox(),
                              ],
                            );
                          }
                        ),
