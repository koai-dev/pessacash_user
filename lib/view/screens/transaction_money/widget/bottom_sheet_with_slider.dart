...
import 'package:six_cash/util/currency/currency.dart';
                            ...
                            children: [
                              ...
                              Text(
                                  widget.transactionType == 'send_money'
                                      ? '${PriceConverter.balanceWithSymbol(balance: Get.find<SplashController>().configModel.sendMoneyChargeFlat.toString())}'
