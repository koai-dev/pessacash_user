...
import 'package:six_cash/view/screens/forget_password/widget/phone_verification.dart';
...
class RouteHelper {
  ...
  static const String send_money_balance_input =
      '/send_money_balance_inputsend_money_balance_input';
  static const String send_money_confirmation =
      '/transaction_money_confirmation.dart';

  static const String requestMoney = '/request_money';
  static const String requestMoney_balance_input =
      '/requestMoney_balance_input';
  ...
  static getSelfieRoute({@required bool fromEditProfile}) =>
      '$selfie_screen?page=${fromEditProfile ? 'edit-profile' : 'verify'}';
  ...
  static getPinSetRoute(
          ...
          String email}) =>
      '$pin_set_screen?occupation=$occupation&f-name=$fName&l-name=$lName&email=$email';
  ...
  static getForgetPassRoute(
          {@required String countryCode, @required String phoneNumber}) =>
      '$f_phone_number_screen?country-code=$countryCode&phone-number=$phoneNumber';

  static getRequestMoneyBalanceInputRoute() => '$requestMoney_balance_input';

  static getRequestMoneyConfirmationRoute(
          {@required String inputBalanceText}) =>
      '$requestMoney_confirmation?input-balance=$inputBalanceText';
  ...
  static getFVeryficationRoute({@required String phoneNumber}) =>
      '$f_verification_screen?phone-number=$phoneNumber';

  static getSupportRoute() => '$support';

  static getCashOutConfirmationRoute({@required String inputBalanceText}) =>
      '$cash_out_confirmation?input-balance=$inputBalanceText';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        name: f_phone_number_screen,
        page: () => ForgetPassword(
              countryCode: Get.parameters['country-code'].replaceAll(' ', '+'),
              phoneNumber: Get.parameters['phone-number'],
            )),
    GetPage(
        name: f_verification_screen,
        page: () => PhoneVerification(
              phoneNumber: Get.parameters['phone-number'].replaceAll(' ', '+'),
            )),
    GetPage(
        name: f_reset_pass_screen,
    ...
    GetPage(
        ...
        page: () => RequestedMoneyListScreen(
            isOwn: Get.parameters['from'] == 'won' ? true : false)),
